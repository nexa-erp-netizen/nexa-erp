...
const styles = {
  ...
  spark: { fontSize: 20 }, panel: { position: "fixed", right: 20, bottom: 20, zIndex: 1300, width: "min(1050px,calc(100vw - 240px))", minWidth: "min(760px,calc(100vw - 28px))", height: "min(820px,calc(100vh - 28px))", display: "flex", flexDirection: "column", overflow: "hidden", borderRadius: 20, border: "1px solid rgba(255,255,255,.16)", background: "#0b1728", boxShadow: "0 28px 90px rgba(0,0,0,.58)" },
