...
export default function CertificadosDigitais() {
  ...
  async function salvar() {
    ...
    try {
      if (editandoId) {
        await api.put(`/certificados-digitais/${editandoId}`, form)
      } else {
        await api.post("/certificados-digitais", form)
      }
      limpar()
      await carregarDados()
    } catch (error) {
    ...
    <div style={styles.page}>
      <div style={styles.hero}>
        <div>
          ...
          <p style={styles.subtitle}>Controle dos certificados A1, validade e localização. O arquivo e a senha não são armazenados nesta etapa.</p>
        </div>
      </div>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.formGrid}>
          ...
          <input style={styles.input} placeholder="Local do arquivo: computador, Google Drive..." value={form.localArquivo} onChange={(e) => alterar("localArquivo", e.target.value)} />
            ...
            return (
              <div key={item.id} style={styles.item}>
                <div style={styles.itemMain}>
                  ...
                  <span style={styles.meta}>{item.autoridadeCertificadora || "Autoridade não informada"}</span>
                  <span style={styles.meta}>Local: {item.localArquivo || "não informado"}</span>
                </div>
